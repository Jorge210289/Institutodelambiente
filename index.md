...
<body>
 ...
 <!-- {% include popup.html %} -->
  <div class="container">
    ...
    <div class="highlight">
      <h1>¡ATENCIÓN!</h1>
      <p>Ya tenemos seleccionados los bachilleres de la  <strong> Promoción 2026 </strong>. Conoce los Bachilleres que avanzan a esta fase</p>
      <a href="https://itesmarena.edu.do/seleccionados2026/" class="btn btn-primary">Más información sobre los seleccionados</a>
    </div>
    <!-- Contenido principal -->
